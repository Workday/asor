...
| Property | Type | Description | Required |
|----------|------|-------------|----------|
| `id` | `string` | Agent Platform Reference ID = "Platform={Platform Name} | ✅ Yes |
...
| `descriptor`     | `string` | In Preview Only ** Only used for Orchestrate Actions ** Name of this Agent Action | ❌ No |
| `type`     | `string` | In Preview Only ** Only used for Orchestrate Actions ** MUST BE the string `AGENT_ACTION` (later will be other action types) | ❌ No |
